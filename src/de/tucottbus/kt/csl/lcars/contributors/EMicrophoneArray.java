...
public class EMicrophoneArray extends ETopography
{
  ...
  /**
   * Returns the currently selected microphone ID or <code>-1</code> if no 
  ...
  {
    // TODO: implement EMicrophoneArray.fireMicSelected(int)
  }
  ...
  {
    float level = (float)Math.max(-75,Math.min(0,20*Math.log10(gain)));
