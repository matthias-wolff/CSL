...
double getDelayFromMicToPoint(__global double* mics, double x, double y, double z, int n)
{
	int i = n*3;
...
double getDbValue(double x, double y, double z, float freq, __global double* mics,__global char* micsActive, __global float* steerVec)
{
    double delta = 0;
    double tau = 0;
    double a_n = 1, w_n = 1;
...
double getDbFromPixel(int x, int y, int sliceSelect, int slicePos, float freq, __global double* mics, __global char* micsActive, __global float* steerVec, int width, int height){
...
__kernel void getSensitivityIntArray(float freq, int sliceSelect, int slicePos, int width, int height, __global double* mics, __global char* micsActive, __global float* steerVec, __global int* out) 
{
...
__kernel void getSensitivityImage(float freq, int sliceSelect, int slicePos, __global double* mics, __global char* micsActive, __global float* steerVec, 
