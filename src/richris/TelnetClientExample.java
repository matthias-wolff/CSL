...
//        TerminalTypeOptionHandler ttopt = new TerminalTypeOptionHandler("ANSI", true, true, false, false);
...
//        }
        ...
        while (true)
        {
            ...
            try
            {
                ...
                System.out.println("TelnetClientExample "+remoteip+":"+remoteport);
                ...
                String login = "login ktuser kt\r\n";
                outstr.write(login.getBytes());
                outstr.flush();
                    ...
                    try
                    {
                        ...
                        if(ret_read > 0)
                        {
                          //for (int i=0; i<ret_read; i++)
                            //System.out.println(buff[i]+" "+new Character((char)buff[i]));
